        ...
        <div className="md:w-2/6 md:pr-3 ">
            ...
            <div className="mx-auto flex w-full flex-col items-center rounded-sm  p-4 shadow-md shadow-moonlight-100">
              ...
              <div className="flex flex-col">
                <div className="mt-2 flex w-full flex-wrap gap-3">
                  <FollowUserButton userID={eventInfos.data.organizer} />
          ...
          <div className="mb-10">
            ...
            <div className="mt-2 w-full text-sm font-light text-moonlight-800">
              {eventInfos.data.levelSuggection}
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="mt-2 w-fit rounded-sm bg-moonlight-500 px-3 py-1 text-sm font-light text-white">
              {convertCategoryCode(eventInfos.data.category)}
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            {eventInfos.data.locations?.map((location: string, index: number) => (
              <div
                key={index}
