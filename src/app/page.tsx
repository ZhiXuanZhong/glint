  ...
  return (
    <main className="fixed left-0 -z-10 h-screen w-screen md:z-50">
      ...
      <div className="relative flex h-[calc(100vh_-_5rem)] w-screen flex-col justify-end">
        <div className="relative bottom-1/4 mx-auto w-2/4 rounded-sm border border-moonlight-50 bg-white px-3 py-1 drop-shadow-xl md:w-3/4 lg:w-full lg:max-w-4xl">
