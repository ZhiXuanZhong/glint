...
const LandingBackground = () => {
  return (
    <div>
      ...
      <div className="absolute left-0 top-0 hidden h-screen w-screen px-96 pt-56 lg:block">
        <MouseParallax lerpEase={0.08} strength={0.02}>
          <div className="mr-auto flex gap-[3px] text-white">
            ...
            <div className="flex h-9 w-9 items-center justify-center border border-sunrise-500 bg-white bg-opacity-20 text-xl font-medium text-sunrise-500">
              T
            </div>
          </div>
          <div className="pt-10 text-5xl font-semibold tracking-widest text-white drop-shadow-xl">
            探索屬於你的水下探險
          </div>
        </MouseParallax>
      </div>
